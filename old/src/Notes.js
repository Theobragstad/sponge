    ...
    <div>
      ...
      {user ? (
        ...
        <button className="gbtn" onClick={auth}>
          <img
            ...
            alt="google logo"
            className="glogo"
            data-tooltip-content={"Log in with Google"}
      ...
      {!allItemsSelected && (
        <button
          ...
          className=" actionbtn checkbox-round hoverselect"
          data-tooltip-id="actiontooltip"
      ...
      {hasSelectedItems && (
        <button
          ...
          className="actionbtn checkbox-round hoverdeselect"
          data-tooltip-id="actiontooltip"
          data-tooltip-content={`deselect all`}
        ></button>
      )}
      {hasSelectedItems && (
        <button
          onClick={deleteSelectedItems}
          className="actionbtn checkbox-round hoverdelete"
          data-tooltip-id="actiontooltip"
              ...
              <div>
                <div className="overview-container">
                  {items?.map(({ id, data }, index) => (
                    <div
                      key={id}
                      className="overview-item itemblock list-item table-row"
                    >
                      {data.item}
                    </div>
                  ))}
